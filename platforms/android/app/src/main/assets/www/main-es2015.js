...
const routes = [
    ...
    {
        path: 'forgotpassword',
        loadChildren: () => __webpack_require__.e(/*! import() | forgotpassword-forgotpassword-module */ "forgotpassword-forgotpassword-module").then(__webpack_require__.bind(null, /*! ./forgotpassword/forgotpassword.module */ "./src/app/forgotpassword/forgotpassword.module.ts")).then(m => m.ForgotpasswordPageModule)
    },
    {
        path: 'intro',
        loadChildren: () => Promise.all(/*! import() | intro-intro-module */[__webpack_require__.e("common"), __webpack_require__.e("intro-intro-module")]).then(__webpack_require__.bind(null, /*! ./intro/intro.module */ "./src/app/intro/intro.module.ts")).then(m => m.IntroPageModule)
    },
    {
        path: 'liste-detail/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | liste-detail-liste-detail-module */ "liste-detail-liste-detail-module").then(__webpack_require__.bind(null, /*! ./liste-detail/liste-detail.module */ "./src/app/liste-detail/liste-detail.module.ts")).then(m => m.ListeDetailPageModule)
    },
    {
        path: 'search/:id',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | liste-invitation-liste-invitation-module */[__webpack_require__.e("common"), __webpack_require__.e("liste-invitation-liste-invitation-module")]).then(__webpack_require__.bind(null, /*! ./liste-invitation/liste-invitation.module */ "./src/app/liste-invitation/liste-invitation.module.ts")).then(m => m.ListeInvitationPageModule)
    },
    {
        path: 'listeproject',
        loadChildren: () => Promise.all(/*! import() | listeproject-listeproject-module */[__webpack_require__.e("common"), __webpack_require__.e("listeproject-listeproject-module")]).then(__webpack_require__.bind(null, /*! ./listeproject/listeproject.module */ "./src/app/listeproject/listeproject.module.ts")).then(m => m.ListeprojectPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, storage, navCtr) {
    ...
    initializeApp() {
        this.platform.ready().then(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const loggedIn = yield this.storage.getItem("LoggedIn");
...
module.exports = __webpack_require__(/*! /Users/chek-taty/Documents/Ionic/aller/ShoppingList/src/main.ts */"./src/main.ts");
