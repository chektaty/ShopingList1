...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(nativeStorage, formBuilder, apiService, alertService, navCtrl, googlePlus) {
      ...
      _createClass(HomePage, [{
        ...
        value: function submit() {
          ...
          this.apiService.login(email, password).subscribe(function (data) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__["NativeStorage"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _services_servie_api_service__WEBPACK_IMPORTED_MODULE_4__["ServieApiService"], src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_5__["AlertService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"], _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_7__["GooglePlus"]])], HomePage);
    /***/
  }
}]);
