...
let InscriptionPage = class InscriptionPage {
    constructor(nativeStorage, formBuilder, apiService, alertService, navCtrl) {
    ...
    submit() {
        ...
        this.apiService.register(email, password).subscribe(data => {
...
InscriptionPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__["NativeStorage"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _services_servie_api_service__WEBPACK_IMPORTED_MODULE_4__["ServieApiService"],
        src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_5__["AlertService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"]])
], InscriptionPage);
